...
```bash
curl -s -X POST "https://api.twilio.com/2010-04-01/Accounts/[REDACTED-RICK-SID]/IncomingPhoneNumbers/PN588e165d4cdc0349998a1e8aa5925f3e.json" \
  -u "[REDACTED-RICK-SID]:67a1db113efa1c78d5e32589c6676f23" \
...
```bash
curl -s "https://api.twilio.com/2010-04-01/Accounts/[REDACTED-RICK-SID]/IncomingPhoneNumbers/PN588e165d4cdc0349998a1e8aa5925f3e.json" \
  -u "[REDACTED-RICK-SID]:67a1db113efa1c78d5e32589c6676f23" | python3 -m json.tool
```
