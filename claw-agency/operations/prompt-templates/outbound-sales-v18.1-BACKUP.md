...
First ask: "Is there a manager or someone who handles operations I could speak with?" If yes, say "That works, could you put me through?" and wait. If no one is available: "No problem. What's the owner's name?" Get the name. Then: "And when's the best time to catch them?" Get the time. Then: "Perfect. I'll try [Name] back then. Appreciate it." Done.
