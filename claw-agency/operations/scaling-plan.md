...
| Task | Details |
|------|---------|
| Client onboarding | Run the checklist, set up workspaces |
...
### Team Structure
```
You (CEO / Sales / Strategy)
├── Tech Lead (architecture, code review, senior dev)
│   ├── Developer 1 (build)
│   └── Developer 2 (build)
...
## Phase 5: Team of 5+ (Month 15+)

**Hire trigger:** Inbound leads you can't service. Want to stop coding.

### Add: Sales / Account Manager
- Handles discovery calls, proposals, follow-ups
- Manages ongoing client relationships
- You focus on strategy, partnerships, product
