# HONE — Pre-Launch Referral Funnel
...
### Hero Section
- **Headline:** "Your beard deserves better. HONE is coming."
...
- **Text/DM:** "Yo, check out HONE — new beard care brand dropping soon. Use my link and you get $10 off: [LINK]"
- **Twitter:** "My beard's about to level up. @HoneGrooming is launching soon and I'm on the early list. $10 off if you join through me → [LINK] #beardcare #HONE"
...
- Campaign name: HONE Pre-Launch Waitlist
...
**3. Design**
- Use HONE brand colors (dark/charcoal + amber/gold accent)
- Upload logo
...
**6. Domain & Tracking**
- Custom referral domain: share.honegrooming.com (or just use default)
