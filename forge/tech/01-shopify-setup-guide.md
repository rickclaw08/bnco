# FORGE — Shopify Store Setup Guide
...
- Store name: **FORGE** (or **FORGE Grooming** if taken)
...
|---|---|
| Store name | FORGE |
| Store contact email | support@forgegrooming.com |
| Sender email | hello@forgegrooming.com |
...
- Set **statement descriptor**: `FORGE GROOMING`
...
- **Logo**: FORGE logo (upload SVG/PNG, max width ~200px)
...
### 4.4 Packing Slips
- Customize packing slip template with FORGE branding
...
- Announcement bar: `#B87333` background, `#F5F0EB` text
  - Example: "FREE SHIPPING ON ORDERS $50+ | FORGE YOUR LOOK"
...
6. **Email Signup** — Klaviyo embedded form
   - "JOIN THE FORGE — 15% off your first order"
...
|---|---|---|
| Page title | `[Product] - [Benefit] | FORGE Grooming` | `Beard Oil - Smokewood Scent for Softer, Healthier Beards | FORGE Grooming` |
| Meta description | 150-160 chars, include benefit + CTA | `Tame and nourish your beard with FORGE Smokewood Beard Oil. Natural ingredients, bold scent. Free shipping on $50+. Shop now.` |
| URL handle | `/products/beard-oil-smokewood` | lowercase, hyphenated |
| Image alt text | Descriptive: `FORGE Smokewood Beard Oil 2oz bottle on dark background` | — |
...
About
  ├── Our Story
  └── Ingredients
Blog (link to /blogs/forge-journal)
```
...
- Blog name: **The Forge Journal**
- Handle: `/blogs/forge-journal`
- Create 3-5 launch posts:
  1. "Why Your Beard Deserves Better" (educational)
  2. "The FORGE Story" (brand story)
...
Customize these email templates with FORGE branding (logo, colors, tone):
- Order confirmation
