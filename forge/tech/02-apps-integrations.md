...
3. **Set up sender domain**: `mail.forgegrooming.com`
...
2. **Widget settings**:
   - Review widget style: match FORGE theme colors
...
3. **Review request emails**:
   ...
   - Customize email template with FORGE branding
4. **Display settings**:
...
2. Pixel name: `FORGE Grooming Pixel`
...
2. **Tracking page**:
   - Create branded tracking page at `forgegrooming.com/pages/track-your-order`
   - Customize with FORGE colors and logo
